...
NativeDateTimeAdapter.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: NativeDateTimeAdapter, factory: function NativeDateTimeAdapter_Factory(t) { return new (t || NativeDateTimeAdapter)(ɵngcc0.ɵɵinject(OWL_DATE_TIME_LOCALE, 8), ɵngcc0.ɵɵinject(Platform)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NativeDateTimeAdapter, [{
        type: Injectable
            ...
            }] }, { type: Platform }]; }, { getYear: [], getMonth: [], getDay: [], getDate: [], getHours: [], getMinutes: [], getSeconds: [], getTime: [], getNumDaysInMonth: [], differenceInCalendarDays: [], getYearName: [], getMonthNames: [], getDayOfWeekNames: [], getDateNames: [], toIso8601: [], isEqual: [], isSameDay: [], isValid: [], invalid: [], isDateInstance: [], addCalendarYears: [], addCalendarMonths: [], addCalendarDays: [], setHours: [], setMinutes: [], setSeconds: [], createDate: [], clone: [], now: [], format: [], parse: [], deserialize: [], createDateWithOverflow: [], stripDirectionalityCharacters: [], _format: [] });
