...
OwlDateTimeInlineComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: OwlDateTimeInlineComponent, selectors: [["owl-date-time-inline"]], factory: function OwlDateTimeInlineComponent_Factory(t) { return new (t || OwlDateTimeInlineComponent)(ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(DateTimeAdapter, 8), ɵngcc0.ɵɵdirectiveInject(OWL_DATE_TIME_FORMATS, 8)); }, viewQuery: function OwlDateTimeInlineComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, hostBindings: function OwlDateTimeInlineComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ...
        ]), ɵngcc0.ɵɵInheritDefinitionFeature], consts: 1, vars: 0, template: function OwlDateTimeInlineComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "owl-date-time-container");
    } }, styles: [""], changeDetection: 0 });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(OwlDateTimeInlineComponent, [{
        type: Component,
        args: [{
            ...
            type: Input
        }], values: [], selected: [], selected: [], selecteds: [], selecteds: [], opened: [], pickerMode: [], isInSingleMode: [], isInRangeMode: [], owlDTInlineClass: [{
            type: HostBinding,
            args: ['class.owl-dt-inline']
        }], ngOnInit: [], writeValue: [], registerOnChange: [], onModelChange: [], registerOnTouched: [], onModelTouched: [], setDisabledState: [], select: [], selectYear: [], selectMonth: [], container: [{
            type: ViewChild,
