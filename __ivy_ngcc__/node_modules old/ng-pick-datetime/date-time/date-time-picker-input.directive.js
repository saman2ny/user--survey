...
OwlDateTimeInputDirective.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: OwlDateTimeInputDirective, selectors: [["input", "owlDateTime", ""]], factory: function OwlDateTimeInputDirective_Factory(t) { return new (t || OwlDateTimeInputDirective)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer2), ɵngcc0.ɵɵdirectiveInject(DateTimeAdapter, 8), ɵngcc0.ɵɵdirectiveInject(OWL_DATE_TIME_FORMATS, 8)); }, hostBindings: function OwlDateTimeInputDirective_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ɵɵallocHostVars(5);
        ɵngcc0.ɵɵlistener("keydown", function OwlDateTimeInputDirective_keydown_HostBindingHandler($event) { return ctx.handleKeydownOnHost($event); });
        ɵngcc0.ɵɵlistener("blur", function OwlDateTimeInputDirective_blur_HostBindingHandler($event) { return ctx.handleBlurOnHost($event); });
        ɵngcc0.ɵɵlistener("input", function OwlDateTimeInputDirective_input_HostBindingHandler($event) { return ctx.handleInputOnHost($event); });
        ɵngcc0.ɵɵlistener("change", function OwlDateTimeInputDirective_change_HostBindingHandler($event) { return ctx.handleChangeOnHost($event); });
    } if (rf & 2) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(OwlDateTimeInputDirective, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: ElementRef }, { type: Renderer2 }, { type: DateTimeAdapter, decorators: [{
                type: Optional
            ...
            }] }]; }, { elmRef: [], renderer: [], dateTimeAdapter: [], dateTimeFormats: [], _selectMode: [], rangeSeparator: [{
            type: Input
        }], _values: [], dateTimeChange: [{
            type: Output
        }], dateTimeInput: [{
            type: Output
        }], dtPickerSub: [], localeSub: [], lastValueValid: [], onModelChange: [], onModelTouched: [], validatorOnChange: [], parseValidator: [], minValidator: [], maxValidator: [], filterValidator: [], rangeValidator: [], validator: [], valueChange: [], disabledChange: [], owlDateTime: [{
            type: Input
        }], owlDateTimeFilter: [{
            type: Input
        }], dateTimeFilter: [], disabled: [], disabled: [], min: [{
            type: Input
        }], min: [], max: [{
            type: Input
        }], max: [], selectMode: [{
            ...
            type: Input
        }], values: [], elementRef: [], isInSingleMode: [], isInRangeMode: [], owlDateTimeInputAriaHaspopup: [{
            type: HostBinding,
            ...
            type: HostBinding,
            args: ['disabled']
        }], ngOnInit: [], ngAfterContentInit: [], ngOnDestroy: [], writeValue: [], registerOnChange: [], registerOnTouched: [], setDisabledState: [], validate: [], registerOnValidatorChange: [], handleKeydownOnHost: [{
            type: HostListener,
            args: ['keydown', ['$event']]
        }], handleBlurOnHost: [{
            type: HostListener,
            ...
            type: HostListener,
            args: ['change', ['$event']]
        }], formatNativeInputValue: [], registerDateTimePicker: [], dtPicker: [], getValidDate: [], convertTimeStringToDateTimeString: [], changeInputInSingleMode: [], _value: [], changeInputInRangeFromToMode: [], changeInputInRangeMode: [], isSameValue: [], _disabled: [{
            type: Input
        }] });
