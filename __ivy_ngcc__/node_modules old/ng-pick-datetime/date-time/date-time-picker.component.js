...
OwlDateTimeComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: OwlDateTimeComponent, selectors: [["owl-date-time"]], factory: function OwlDateTimeComponent_Factory(t) { return new (t || OwlDateTimeComponent)(ɵngcc0.ɵɵdirectiveInject(Overlay), ɵngcc0.ɵɵdirectiveInject(ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(OwlDialogService), ɵngcc0.ɵɵdirectiveInject(NgZone), ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(DateTimeAdapter, 8), ɵngcc0.ɵɵdirectiveInject(OWL_DTPICKER_SCROLL_STRATEGY), ɵngcc0.ɵɵdirectiveInject(OWL_DATE_TIME_FORMATS, 8), ɵngcc0.ɵɵdirectiveInject(DOCUMENT, 8)); }, inputs: { startAt: "startAt", pickerType: "pickerType", pickerMode: "pickerMode", disabled: "disabled", opened: "opened", backdropClass: "backdropClass", panelClass: "panelClass", scrollStrategy: "scrollStrategy" }, outputs: { afterPickerClosed: "afterPickerClosed", afterPickerOpen: "afterPickerOpen", yearSelected: "yearSelected", monthSelected: "monthSelected" }, exportAs: ["owlDateTime"], features: [ɵngcc0.ɵɵInheritDefinitionFeature], consts: 0, vars: 0, template: function OwlDateTimeComponent_Template(rf, ctx) { }, styles: [""], changeDetection: 0 });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(OwlDateTimeComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: Overlay }, { type: ViewContainerRef }, { type: OwlDialogService }, { type: NgZone }, { type: ChangeDetectorRef }, { type: DateTimeAdapter, decorators: [{
                type: Optional
            ...
            type: Input
        }], opened: [], dtInput: [], selected: [], selected: [], selecteds: [], selecteds: [], minDateTime: [], maxDateTime: [], dateTimeFilter: [], selectMode: [], isInSingleMode: [], isInRangeMode: [], ngOnInit: [], ngOnDestroy: [], registerInput: [], _dtInput: [], dtInputSub: [], open: [], focusedElementBeforeOpen: [], hidePickerStreamSub: [], confirmSelectedStreamSub: [], select: [], selectYear: [], selectMonth: [], close: [], pickerOpenedStreamSub: [], dialogRef: [], confirmSelect: [], openAsDialog: [], pickerContainer: [], openAsPopup: [], pickerContainerPortal: [], createPopup: [], popupRef: [], createPopupPositionStrategy: [], backdropClass: [{
            type: Input
        }], panelClass: [{
            type: Input
        }], scrollStrategy: [{
