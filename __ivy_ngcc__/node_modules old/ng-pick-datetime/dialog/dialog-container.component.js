...
OwlDialogContainerComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: OwlDialogContainerComponent, selectors: [["owl-dialog-container"]], factory: function OwlDialogContainerComponent_Factory(t) { return new (t || OwlDialogContainerComponent)(ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(FocusTrapFactory), ɵngcc0.ɵɵdirectiveInject(DOCUMENT, 8)); }, viewQuery: function OwlDialogContainerComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(CdkPortalOutlet, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadViewQuery()) && (ctx.portalOutlet = _t.first);
    } }, hostBindings: function OwlDialogContainerComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ɵɵallocHostVars(7);
        ɵngcc0.ɵɵcomponentHostSyntheticListener("@slideModal.start", function OwlDialogContainerComponent_animation_slideModal_start_HostBindingHandler($event) { return ctx.onAnimationStart($event); });
        ɵngcc0.ɵɵcomponentHostSyntheticListener("@slideModal.done", function OwlDialogContainerComponent_animation_slideModal_done_HostBindingHandler($event) { return ctx.onAnimationDone($event); });
        ɵngcc0.ɵɵstyling();
    } if (rf & 2) {
    ...
    } }, features: [ɵngcc0.ɵɵInheritDefinitionFeature], consts: 1, vars: 0, template: function OwlDialogContainerComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, OwlDialogContainerComponent_ng_template_0_Template, 0, 0, "ng-template", _c0);
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(OwlDialogContainerComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ChangeDetectorRef }, { type: ElementRef }, { type: FocusTrapFactory }, { type: Object, decorators: [{
                type: Optional
            }, {
                type: Inject,
                args: [DOCUMENT]
            }] }]; }, { config: [], owlDialogContainerClass: [{
            type: HostBinding,
            ...
            type: HostBinding,
            args: ['@slideModal']
        }], ngOnInit: [], attachComponentPortal: [], attachTemplatePortal: [], setConfig: [], _config: [], onAnimationStart: [{
            type: HostListener,
            args: ['@slideModal.start', ['$event']]
        }], isAnimating: [], onAnimationDone: [{
            type: HostListener,
            args: ['@slideModal.done', ['$event']]
        }], startExitAnimation: [], state: [], calculateZoomOrigin: [], savePreviouslyFocusedElement: [], elementFocusedBeforeDialogWasOpened: [], trapFocus: [], focusTrap: [], restoreFocus: [], portalOutlet: [{
            type: ViewChild,
