...
OwlDialogService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: OwlDialogService, factory: function OwlDialogService_Factory(t) { return new (t || OwlDialogService)(ɵngcc0.ɵɵinject(Overlay), ɵngcc0.ɵɵinject(Injector), ɵngcc0.ɵɵinject(Location, 8), ɵngcc0.ɵɵinject(OWL_DIALOG_SCROLL_STRATEGY), ɵngcc0.ɵɵinject(OWL_DIALOG_DEFAULT_OPTIONS, 8), ɵngcc0.ɵɵinject(OwlDialogService, 12), ɵngcc0.ɵɵinject(OverlayContainer)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(OwlDialogService, [{
        type: Injectable
                ...
                type: SkipSelf
            }] }, { type: OverlayContainer }]; }, { overlay: [], injector: [], location: [], scrollStrategy: [], defaultOptions: [], parentDialog: [], overlayContainer: [], ariaHiddenElements: [], _openDialogsAtThisLevel: [], _afterOpenAtThisLevel: [], _afterAllClosedAtThisLevel: [], afterAllClosed: [], openDialogs: [], afterOpen: [], _afterAllClosed: [], open: [], closeAll: [], getDialogById: [], attachDialogContent: [], createInjector: [], createOverlay: [], attachDialogContainer: [], getOverlayConfig: [], removeOpenDialog: [], hideNonDialogContentFromAssistiveTechnology: [] });
